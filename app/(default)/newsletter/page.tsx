          ...
          <div className="py-12 md:py-20">
            ...
            <div className="pb-12 text-center">
              <div className="mb-3 inline-flex">
                <div className="relative flex items-center gap-2 rounded-full bg-gray-900/90 p-1 pr-3 text-sm text-gray-100/70 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,var(--color-gray-800),var(--color-gray-700),var(--color-gray-800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] after:absolute after:inset-0 after:-z-10 after:backdrop-blur-xs">
                  ...
                  <span>
                    <strong className="font-normal text-gray-200">2K</strong>{" "}
            ...
            >
              ...
              <input type="hidden" name="_next" value="https://inboundtribe.com/contact" />
              ...
              <div className="flex gap-3">
                <input
                  id="email"
                  type="email"
                  name="email"  // Important: This ensures FormSubmit receives the email
                  required
                  className="form-input w-full"
                  placeholder="Your email address"
                  aria-label="Email"
                />
                <button type="submit" className="btn group w-full flex-1 bg-linear-to-t from-orange-600 to-orange-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_--theme(--color-white/.16)] hover:bg-[length:100%_150%]">
