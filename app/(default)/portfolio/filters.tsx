  ...
  return (
    <div className="flex justify-center pb-12 max-md:hidden md:pb-20">
      <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
        {/* Button #1 */}
        <button
          className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === "All" ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
          aria-pressed={category === "All"}
          onClick={() => setCategory("All")}
        >
          <svg
            className={`fill-current ${category === "All" ? "text-orange-500" : "text-gray-600"}`}
        ...
        {/* Button #2 */}
        <button
          className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === "AI Content" ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
          aria-pressed={category === "Websites"}
          onClick={() => setCategory("Websites")}
        >
          <svg
            className={`fill-current ${category === "Websites" ? "text-orange-500" : "text-gray-600"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
        ...
        {/* Button #3 */}
        <button
          className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === "Content Production" ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
          aria-pressed={category === "Content Production"}
          onClick={() => setCategory("Content Production")}
        >
          <svg
            className={`fill-current ${category === "Content Production" ? "text-orange-500" : "text-gray-600"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
        ...
        {/* Button #4 */}
        <button
          className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === "Advertising" ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
          aria-pressed={category === "Advertising"}
          onClick={() => setCategory("Advertising")}
        >
          <svg
            className={`fill-current ${category === "Advertising" ? "text-orange-500" : "text-gray-600"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
        ...
        {/* Button #5 */}
        <button
          className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === "Branding" ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
          aria-pressed={category === "Branding"}
          onClick={() => setCategory("Branding")}
        >
          <svg
            className={`fill-current ${category === "Branding" ? "text-orange-500" : "text-gray-600"}`}
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          >
