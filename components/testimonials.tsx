...
import ClientImg10 from "@/public/images/client-logo-10.svg";
import ClientImg11 from "@/public/images/client-logo-11.svg";

const testimonials = [
  {
    img: TestimonialImg02,
    clientImg: ClientImg10,
    name: "Colvin Wanigasekara",
    company: "Twinvilla Red",
    content:
      "I strongly recommend inboundtribe and their services to anyone interested in running a successful online business! inboundtribe helped us with creating a professional website that takes our business to a whole new level.",
    categories: [1, 3, 5],
  },
  {
    img: TestimonialImg01,
    clientImg: ClientImg11,
    name: "Stephanie Markhay",
    company: "Riot Energy",
    content:
      "Inboundtribe helped us with our ecommerce site. Vinoth and the team did a great job at delivering on time and being flexible with the prices. Would defenitely recommend these guys.",
    categories: [1, 2, 4],
  },
  {
  ...
  },
  {
    ...
    clientImg: ClientImg10,
    name: "Ian McCall",
    company: "Athletes Journey Home",
    content:
      "I've had and continue to have an incredibly good time working with inboundtribe. They are extremely efficient and helpful. on top of it all they are nice good hearted people that want to make a difference.",
    categories: [1, 4],
  },
  {
    ...
    company: "Matthew & Co",
    content:
      "Inboundtribe helped me run Facebook ads for my business, and it’s been great! They explained everything clearly and handled the entire setup.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Gloxium",
    content:
      "I highly recommend inboundtribe for anyone in need of a web design and development agency. They offer a balanced combination of creative design, technical excellence, and outstanding...",
    categories: [1, 3],
  },
  {
    ...
    company: "Bringer",
    content:
      "Top-notch service from start to finish! They listened to what I needed and delivered better than I expected. Amazing team!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Bringer",
    content:
      "I needed a landing page for my product, and Inboundtribe made a perfect one. It’s very attractive and has increased my conversion rates. The team was very quick and professional.",
    categories: [1, 4],
  },
  {
    ...
    company: "Creator",
    content:
      "I wanted to have High retention edits for my tiktok and reels. Came to inboundtribe with a couple of ideas and they made it into a 30 day post marathon. The team really works with your ideas and needs.",
    categories: [1, 2],
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-gray-100/75">
          See what our clients say about our strategy driven creative solutions  that help brands grow and connect with their audience anywhere in the world.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              {/* Button #1 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === 1 ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
                aria-pressed={category === 1}
                onClick={() => setCategory(1)}
              >
                <svg
                  className={`fill-current ${category === 1 ? "text-orange-500" : "text-gray-600"}`}
              ...
              {/* Button #2 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === 2 ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
                aria-pressed={category === 2}
                onClick={() => setCategory(2)}
              >
                <svg
                  className={`fill-current ${category === 2 ? "text-orange-500" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
              ...
              {/* Button #3 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === 3 ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
                aria-pressed={category === 3}
                onClick={() => setCategory(3)}
              >
                <svg
                  className={`fill-current ${category === 3 ? "text-orange-500" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
              ...
              {/* Button #4 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === 4 ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
                aria-pressed={category === 4}
                onClick={() => setCategory(4)}
              >
                <svg
                  className={`fill-current ${category === 4 ? "text-orange-500" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
              ...
              {/* Button #5 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-200 ${category === 5 ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-orange-500/0),--theme(--color-orange-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]" : "opacity-65 transition-opacity hover:opacity-90"}`}
                aria-pressed={category === 5}
                onClick={() => setCategory(5)}
              >
                <svg
                  className={`fill-current ${category === 5 ? "text-orange-500" : "text-gray-600"}`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
                >
