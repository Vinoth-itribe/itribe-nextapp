...
import FeaturesImage from "@/public/images/features-board.gif";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            Subscription designed for non-stop content
            </h2>
            <p className="text-lg text-gray-100/90">
            Our subscription gives you instant access to a creative
             dashboard where you can submit unlimited requests, 
            and get high quality designs without the back and forth hassle.
            </p>
          </div>
          <div className="flex justify-center pb-12 md:pb-12" data-aos="fade-up">
            <Image
              className="max-w-none"
              src={FeaturesImage}
              width={720}
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              Make unlimited requests while subscribed, just like having your own in-house team. 
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-gray-100/90">
              You will receive full ownership of all assets produced as part of the subscription.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-gray-100/90">
              Markets, industries and minds change quickly, don’t get penalized for revisions. 
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-gray-100/90">
              Requests are completed in 24 to 48 hours on average depending on the task.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-gray-100/90">
              Budgeting is simple when there is only one fixed cost per month cost.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-gray-100/90">
              Scale up, down, pause, or cancel your subscription anytime.
              </p>
            </article>
          </div>
        </div>
