        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center">
            <h2 className="text-white pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              Global Team, Limitless Potential
            </h2>
            <p className="text-lg text-gray-100/90">
              At Inboundtribe, our team spans continents, time zones, and cultures – creating 
              a melting pot of brilliance that makes our coffee machine confused about when to start brewing.
            </p>
          </div>
          {/* Check list */}
          <div className="flex justify-center pb-16">
            <ul className="inline-flex flex-col flex-wrap justify-center gap-x-10 gap-y-4 text-[1rem] text-gray-200/65 sm:flex sm:flex-row sm:items-center">
              ...
              <li className="flex items-center">
                ...
                <span>Different Backgrounds, Better Ideas
                </span>
              </li>
              <li className="flex items-center">
                <svg
              ...
              <li className="flex items-center">
                ...
                <span>More Skills, More Fun</span>
              </li>
            </ul>
          </div>
          {/* World map */}
